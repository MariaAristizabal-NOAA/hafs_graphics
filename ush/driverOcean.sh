...
startDate=${4:-2019082900}
  echo "./driverDomain.sh HAFS IDA 09L 2019082800 yes plot_sst.py f036"
fi
...
COMhafs=${COMhafs:-/scratch1/NCEPDEV/hwrf/scrub/${USER}/hafsv1_merge_mom6_hfsa_mom6/com/${startDate}/${STORMID}}
HOMEgraph=${HOMEgraph:-/scratch1/NCEPDEV/hwrf/save/${USER}/hafs_graphics_production_hafs.v1_my_fork_feature_hafs_mom6}
